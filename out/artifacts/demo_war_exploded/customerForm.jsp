...
<html>
<head>
    <title>${empty customer ? 'Add' : 'Edit'} Customer - Pahana Edu</title>
    ...
    <div class="px-4 py-6 sm:px-0">
        <div class="border-4 border-dashed border-gray-200 rounded-lg p-6">
            <div class="flex justify-between items-center mb-6">
                ...
                <a href="${pageContext.request.contextPath}/customers/list" class="text-indigo-600 hover:text-indigo-800 flex items-center">
            ...
            <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                <div class="px-4 py-5 sm:p-6">
                    <form action="${pageContext.request.contextPath}/customers/${empty customer ? 'add' : 'update'}" method="post">
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <input type="text" name="accountNo" id="accountNo" value="${customer.accountNo}" required
                                       class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md p-2 border"
                                ${empty customer ? '' : 'readonly'}>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="number" name="unitsConsumed" id="unitsConsumed" value="${customer.unitsConsumed}" required
                                       class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md p-2 border">
                            </div>
                            ...
                            <div class="sm:col-span-2">
                                ...
                                <textarea id="address" name="address" rows="3" required
                                          class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md p-2 border">${customer.address}</textarea>
                            </div>
                        </div>

                        <div class="mt-6">
                            <button type="submit" class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                <i class="fas fa-save mr-2"></i> ${empty customer ? 'Add Customer' : 'Update Customer'}
                            </button>
                            <a href="${pageContext.request.contextPath}/customers/list" class="ml-3 inline-flex justify-center py-2 px-4 border border-gray-300 shadow-sm text-sm font-medium rounded-md text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                                Cancel
                            </a>
                        </div>
                    </form>
